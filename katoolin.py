...
def main():
 ...
 \033[1;32m+ -- -- +=[ Çeviri: Slayeri4 / White Hat Hacker \033[1;m


\033[1;91m[W] Sisteminizi güncellemeden önce, lütfen herhangi bir problemi önlemek için tüm Kali-linux depolarını kaldırın .\033[1;m
		''')
		def inicio1():
			while True:
				print ('''
1) Yeni Kali Depoları Ekle Ve Güncelle 
2) Kategorileri Görüntüle
3) Klasik Menü Göstergesini Yükle
...
4) Sources.list dosyasının içeriğini görüntüle
					...
					if repo == "1":
						...
						delete_list = ["# Kali linux depoları | Katoolin tarafından eklendi\n", "deb http://http.kali.org/kali kali-rolling main contrib non-free\n"]
						fin = open(infile)
						...
						fin.close()
						fout.close()
						print ("\033[1;31m\nTüm Kali Linux Depoları Silindi !\n\033[1;m")
					elif repo == "back":
						inicio1()
					elif repo == "gohome":
						inicio1()
						...
						print ("\033[1;31mÜzgünüm, Hatalı Seçim!\033[1;m") 					
						

				if opcion0 == "3":
					print (''' 
ClassicMenu Göstergesi, Ubuntu Unity Masaüstü ortamı üst paneli (uygulama göstergesi) bildirim alanı uygulaması.

Unity dash menü, bunu tercih edenler için klasik, GNOME tarzı uygulama menüsü ile basit bir yol sağlar.

Eğer yüklü olanlar varsa klasik GNOME menüsü gibi, Wine oyunları ve uygulamaları içerir.

Daha Fazla Bilgi İçin , Ziyaret Edin : http://www.florian-diesch.de/software/classicmenu-indicator/

''')
					repo = raw_input("\033[1;32mKlasik menü göstergesini yüklemek istediğinize emin misiniz ? [y/n]> \033[1;m")
					if repo == "y":
					...
					repo = raw_input("\033[1;32mKali menüsünü yüklemek istediğinize emin misiniz ? [y/n]> \033[1;m")
					if repo == "y":
...
\033[1;32mgeri\033[1;m 	       \033[1;32manasayfa\033[1;m	
		...
		''')
				...
				def inicio():
					while opcion0 == "2":
						print ('''
\033[1;36m**************************** Tüm Kategoriler *****************************\033[1;m

1) Bilgi Toplama			        8) Exploit Araçları
2) Güvenlik Açığı Analizi			9) Forensic Araçları
3) Wireless Atakları				10) Stres Testi
4) Web Uygulamaları				11) Şifre Saldırıları
5) Sniffing & Spoofing				12) Tersine Mühendislik
6) Maintaining Access				13) Donanım Hacking
7) Raporlama Araçları 				14) Ekstra
									
0) Hepsi

			 ''')
						print ("\033[1;32mBir kategori seçin veya (0) a basarak tüm Kali Linux toollarını yükleyin .\n\033[1;m")

						opcion1 = raw_input("\033[1;36mkat > \033[1;m")
						if opcion1 == "geri":
							inicio1()
						elif opcion1 == "anasayfa":
							inicio1()
						elif opcion1 == "0":
						...
						while opcion1 == "1":
							print ('''
\033[1;36m=+[ Bilgi Toplama\033[1;m
...
0) Tüm Bilgi Toplama araçlarını yükle
				 
						''')
							print ("\033[1;32mYüklemek istediğiniz aracın numarasını giriniz .\n\033[1;m")
						...
						while opcion1 == "2":
							print ('''
\033[1;36m=+[ Güvenlik Açığı Analizi\033[1;m
...
0) Tüm Güvenlik Açığı Analizi araçlarını yükle
						...
						while opcion1 == "3":
							print ('''
		\033[1;36m=+[ Wireless Atakları\033[1;m
...
0) Tüm Wireless Atak araçlarını yükle
						...
						while opcion1 == "4":
							print ('''
\033[1;36m=+[ Web Uygulamaları\033[1;m
...
0) Türm Web Uygulamaları araçlarını yükle
...
0) Tüm Sniffing & Spoofing araçlarını yükle
...
0) Tüm Maintaining Access araçlarını yükle
						...
						while opcion1 == "7":
							print ('''
\033[1;36m=+[ Raporlama Araçları\033[1;m
...
0) Tüm Raporlama Araçlarını yükle
						...
						while opcion1 == "8":
							print ('''
\033[1;36m=+[ Exploit Araçları\033[1;m
...
0) Tüm Exploit Araçlarını yükle
						...
						while opcion1 == "9":
							print ('''
\033[1;36m=+[ Forensic Araçları\033[1;m
...
0) Tüm Forensic Araçlarını yükle
...
0) Tüm Stres Testi araçlarını yükle
						...
						while opcion1 == "11":
							print ('''
\033[1;36m=+[ Şifre Saldırıları\033[1;m
...
0) Tüm Şifre Saldırıları araçlarını yükle
						...
						while opcion1 == "12" :
							print ('''
\033[1;36m=+[ Tersine Mühendislik\033[1;m
...
0) Tüm Tersine Mühendislik araçlarını yükle
						...
						while opcion1 == "13" :
							print ('''
\033[1;36m=+[ Donanım Hacking\033[1;m
...
0) Tüm Donanım Hacking araçlarını yükle
...
2) Squid3
		...
		print ("Kapatma İstemi...İyi Günler...")
	except Exception:
